...
%CSCPATH%\csc /reference:bin\Newtonsoft.Json.dll;bin\RestSharp.dll /target:library /out:package\lib\HostMe.Client.dll /recurse:src\*.cs /doc:package\lib\HostMe.Sdk.xml
